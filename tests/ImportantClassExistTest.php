...
final class ImportantClassExistTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists('Blocksy\Database'), "Class Database does not exist");
    }

    public function test_WpHooksManager_class_exists()
    {
        $this->assertTrue(class_exists('Blocksy\WpHooksManager'), "Class WpHooksManager does not exist");
    }
}
